...
if quantidade > 0:
    ...
    if 0 < quantidade <= 4:  # condição para execução de valores até 4 unidades
        ...
        total_sem_desconto = valor * quantidade #calculo sem desconto
        ...
        total_sem_desconto = valor * quantidade #calculo sem desconto
        desconto = 0.03 * total_sem_desconto #calculo do desconto
        total_com_desconto = total_sem_desconto - desconto #aplicando desconto e calculando
        print('O valor sem desconto foi: R$', total_sem_desconto)
        ...
        total_sem_desconto = valor * quantidade #calculo sem desconto
        desconto = 0.06 * total_sem_desconto  #calculo do desconto
        total_com_desconto = total_sem_desconto - desconto #aplicando desconto e calculando
        print('O valor sem desconto foi: R$', total_sem_desconto)
        ...
        total_sem_desconto = valor * quantidade #calculo sem desconto
        desconto = 0.1 * total_sem_desconto  #calculo do desconto
        total_com_desconto = total_sem_desconto - desconto #aplicando desconto e calculando
        print('O valor sem desconto foi: R$', total_sem_desconto)
